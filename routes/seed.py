...
def seed_recipes():
    try:
        ...
        new_recipes = [
            {'title': 'Sushi Rolls', 'description': 'Fresh Japanese sushi with vinegared rice, nori, and fresh fish', 'ingredients': '2 cups sushi rice\n3 cups water\n1/4 cup rice vinegar\n2 tbsp sugar\n1 tsp salt\nNori sheets\nFresh salmon\nCucumber\nAvocado\nSoy sauce\nWasabi\nPickled ginger', 'instructions': 'Rinse sushi rice under cold water until water runs clear\nCook rice with water in rice cooker or pot\nMix rice vinegar, sugar, and salt in small bowl\nSpread cooked rice on large plate and drizzle vinegar mixture over it\nGently fold rice while fanning to cool it down\nPlace bamboo rolling mat on clean surface and put nori sheet shiny side down\nWet hands and spread thin layer of rice over nori, leaving 1 inch at top\nArrange salmon, cucumber, and avocado in line across center of rice\nUsing bamboo mat, roll nori tightly away from you\nPress gently to seal the roll\nWet sharp knife and slice roll into 8 pieces\nServe with soy sauce, wasabi, and pickled ginger', 'prep_time': 30, 'cook_time': 20, 'servings': 4, 'country': 'Japan', 'image_url': 'https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=600', 'user_id': users['Japan'].id},
            {'title': 'Coq au Vin', 'description': 'Classic French braised chicken in red wine', 'ingredients': '1 whole chicken\n750ml red wine\n200g bacon\n250g mushrooms\n12 pearl onions\n3 cloves garlic\n2 carrots\n2 tbsp flour\nBouquet garni\nButter\nSalt and pepper', 'instructions': 'Cut chicken into 8 pieces and season with salt and pepper\nCut bacon into small pieces and cook in large pot until crispy\nRemove bacon and brown chicken pieces in bacon fat until golden\nRemove chicken and set aside with bacon\nAdd pearl onions and cook until caramelized\nAdd sliced carrots and minced garlic, cook for 2 minutes\nSprinkle flour over vegetables and stir well\nPour in red wine and bring to boil, scraping bottom of pot\nReturn chicken and bacon to pot\nAdd bouquet garni and reduce heat to simmer\nCover and cook for 45 minutes\nAdd mushrooms and cook for 15 more minutes\nRemove bouquet garni and adjust seasoning\nServe hot with crusty bread or mashed potatoes', 'prep_time': 20, 'cook_time': 65, 'servings': 4, 'country': 'France', 'image_url': 'https://images.unsplash.com/photo-1598103442097-8b74394b95c6?w=600', 'user_id': users['France'].id},
